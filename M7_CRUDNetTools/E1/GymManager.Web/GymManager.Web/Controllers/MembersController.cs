...
namespace GymManager.Web.Controllers
{
    ...
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            Log.Information("Total members= " + members?.Count);
        ...
        public async Task<IActionResult> SearchMembershipDetailsList(int id)
        {
            try
            {
                ...
                {
                    // Si no se encontró el miembro, mostrar un mensaje de error o redirigir a una vista de error
                    Log.Information("This member was not found");
                    // Aquí puedes guardar el error en la base de datos si lo deseas

                    // Redirigir a la vista de error en ErrorController
            ...
            {
                // Manejar cualquier excepción que pueda ocurrir
                Log.Error(ex, "An error occurred while searching for the member.");
