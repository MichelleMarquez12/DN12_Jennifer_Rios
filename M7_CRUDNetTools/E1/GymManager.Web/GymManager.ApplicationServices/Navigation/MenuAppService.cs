            ...
            menu.Add(new UserMenuItem
            {
                ...
                Items = new List<UserMenuItem>()
                {
                    ...
                    new UserMenuItem
                    {
                        ...
                        DisplayName = "Equipament Types",
                        Order = 2,
                        Url= "/EquipamentTypes/"
                    },
                    new UserMenuItem
                    {
                        Name = "EquipamentInventory",
                        DisplayName = "Equipament Inventory",
                        Order = 3,
                        Url= "/EquipamentInventory/"
                    },
                    new UserMenuItem
                    {
                        Name = "UserManagement",
            ...
            menu.Add(new UserMenuItem
            {
                ...
                Items = new List<UserMenuItem>()
                {
                    ...
                    new UserMenuItem
                    {
                        ...
                        DisplayName = "StaffAttendance",
                        Order = 1,
                        Url= "/Reports/StaffAttendance"
                    },
                    new UserMenuItem
                    {
